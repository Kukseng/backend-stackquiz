...
public interface HostDashboardService {
    ...
    /**
     * Get Kahoot-style question analytics for SYNC mode
     * Shows statistics after each question: participation, accuracy, top 3, etc.
     *
     * @param sessionCode The session code
     * @return Question analytics with statistics and top 3 leaderboard
     */
